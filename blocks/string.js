...
Blockly.Blocks['string_declare'] = {
    // Variable setter.
    helpUrl: 'http://easycoding.tn/index.php/nodemcu/tuniot-documentation/string-object/',
    init: function () {
...
Blockly.Blocks['string_get'] = {
     ...
     */
    init: function () {
        this.setHelpUrl('http://easycoding.tn/index.php/nodemcu/tuniot-documentation/string-object/');
        this.setColour(Blockly.Blocks.string.HUE);
...
Blockly.Blocks['string_toint'] = {
    init: function () {
        this.setColour(Blockly.Blocks.string.HUE);
        this.appendDummyInput()
                .appendField(Blockly.Msg.STRING_toInt);
        this.appendDummyInput()
                .appendField(new Blockly.FieldString(
                        Blockly.Msg.VARIABLES_DEFAULT_NAME), 'VAR');
        this.setInputsInline(true);
...
Blockly.Blocks['string_tofloat'] = {
    init: function () {
        this.setColour(Blockly.Blocks.string.HUE);
        this.appendDummyInput()
                .appendField(Blockly.Msg.STRING_toFloat);
        this.appendDummyInput()
                .appendField(new Blockly.FieldString(
                        Blockly.Msg.VARIABLES_DEFAULT_NAME), 'VAR');
        this.setInputsInline(true);
...
Blockly.Blocks['string_indexof'] = {
    init: function () {
        ...
        this.appendValueInput("input_to_compare")
                .setAlign(Blockly.ALIGN_CENTRE)
                .appendField(Blockly.Msg.IndexOf);
        this.setInputsInline(true);
        this.setOutput(true, "Number");
        this.setTooltip('');
        this.setHelpUrl("http://easycoding.tn/index.php/nodemcu/tuniot-documentation/string-object/");
...
Blockly.Blocks['string_iot_clearhttp'] = {
    init: function () {
        this.appendDummyInput()
                .appendField(new Blockly.FieldString(
                        Blockly.Msg.VARIABLES_DEFAULT_NAME), 'VAR');
        ...
        this.appendDummyInput()
                .appendField(Blockly.Msg.IOT_ClearServerRequest);
        this.setInputsInline(true);
...
Blockly.Blocks['string_iot_clearhttp_Client'] = {
    init: function () {
        this.appendDummyInput()
                .appendField(new Blockly.FieldString(
                        Blockly.Msg.VARIABLES_DEFAULT_NAME), 'VAR');
        ...
        this.appendDummyInput()
                .appendField(Blockly.Msg.IOT_ClearClientRequest);
        this.setInputsInline(true);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setTooltip('');
...
Blockly.Blocks['string_tochararray'] = {
  init: function() {
        this.appendDummyInput()
            .appendField(new Blockly.FieldString(
                Blockly.Msg.VARIABLES_DEFAULT_NAME), 'VAR');
    this.appendValueInput("char_array")
        .setCheck(null)
        .appendField(Blockly.Msg.STRING_tochararray);
    this.appendValueInput("char-taille")
        .setCheck(null)
        .appendField(Blockly.Msg.STRING_Length);
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setColour(Blockly.Blocks.string.HUE);
