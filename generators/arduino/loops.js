...
Blockly.Arduino.controls_forOld = function() {
  // For loop.
...
Blockly.Arduino['controls_for'] = function(block) {
  ...
  Blockly.Arduino.definitions_['var_'+variable0]='int '+variable0+';'
  ...
  if (Blockly.isNumber(argument0) && Blockly.isNumber(argument1) &&
    ...
    if (!argument0.match(/^\w+$/) && !Blockly.isNumber(argument0)) {
      ...
      code += '' + startVar + ' = ' + argument0 + ';\n';
       Blockly.Arduino.definitions_[startVar]='int '+startVar+';'
    ...
    if (!argument1.match(/^\w+$/) && !Blockly.isNumber(argument1)) {
      ...
      code += '' + endVar + ' = ' + argument1 + ';\n';
       Blockly.Arduino.definitions_[endVar]='int '+endVar+';'
    }
    ...
    code += '' + incVar + ' = ';
    Blockly.Arduino.definitions_[incVar]='int '+incVar+';'
