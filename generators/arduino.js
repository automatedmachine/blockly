...
var profile = {
  arduino: {
    ...
    digital: [["D0", "16"],["D1", "5"], ["D2", "4"], ["D3", "0"], ["D4", "2"],["D5", "14"], ["D6", "12"], ["D7", "13"], ["D8", "15"], ["RX", "3"], ["TX", "1"]],
    digital_2: [["D0", "16"],["D1", "5"], ["D2", "4"], ["D3", "0"],["D4", "2"], ["D5", "14"], ["D6", "12"], ["D7", "13"], ["D8", "15"], ["RX", "3"], ["TX", "1"]],
    analog: [["A0", "A0"]],
    serial: 9600
  },
  arduino_mega: {
...
Blockly.Arduino.finish = function(code) {
  //TEST GENEREATED WITH LOVE
  var gener_arduino="/////////////////////////////////\n";
  gener_arduino += "// Generated with a lot of love//\n";
  gener_arduino += "// with TUNIOT FOR ESP8266     //\n";
  gener_arduino += "// Website: Easycoding.tn      //\n";
  gener_arduino += "/////////////////////////////////\n";
    
 // Convert the HTTP dictionary into a list.
  var declarehttp = [];
  for (var name in Blockly.Arduino.declarehttp_) {
  ...
  //FIN SETUP
  var setupsfin = [];
    for (var name in Blockly.Arduino.setupsfin_) {
